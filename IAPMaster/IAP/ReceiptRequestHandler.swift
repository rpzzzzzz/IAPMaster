...
typealias RequestReceiptCallback = (error:NSError?) -> ()
typealias ReceiptVerifyCallback = (receipt:NSDictionary?,error:NSError?) -> ()
...
class ReceiptRequestHandler: NSObject ,SKRequestDelegate{
